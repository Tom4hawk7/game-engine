...
cmake .. -G Ninja -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DCMAKE_TOOLCHAIN_FILE=conan_toolchain.cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=1

# Build the project (using the build system generated by CMake)
cmake --build .

# Execute the compiled binary ("game-engine" defined in the CMakeLists.txt)
./game-engine
